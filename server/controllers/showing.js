...
const getShowingsByCinemaAndDate = async (req, res) => {
  try {
    const showings = await showingUtils.getShowingsByCinemaAndDate(
...
const getShowingsByCinemaMovieDate = async (req, res) => {
  try {
    const showings = await showingUtils.getShowingsByCinemaMovieDate(
      req.params.cinema_id,
...
const getHallSizeByShowingId = async (req, res) => {
  try {
    const hallSize = await showingUtils.getHallSizeByShowingId(
